...
public class Seminar extends AppCompatActivity implements View.OnClickListener {
    public static EditText kodeTiket;
    private Button btnSubmit, btnBack;

    private MyService service = ServiceGenerator.createService(MyService.class);
    private LinearLayout layoutSeminar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Absensi Seminar");
        ...
        layoutSeminar = findViewById(R.id.layout_seminar);
        ...
        switch (view.getId()){
            case R.id.kode_tiket:
                ...
                if(ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA)
                    ...
                    Intent intent = new Intent(Seminar.this,
            ...
            case R.id.btn_submit:
                ...
                Call<String> call = service.seminar(idTiket);
                call.enqueue(new Callback<String>() {
                    @Override
                    public void onResponse(Call<String> call, Response<String> response) {
                        pgBar.setVisibility(View.GONE);
                        kodeTiket.setText("");
                        Snackbar snackbar = Snackbar.make(layoutSeminar,
