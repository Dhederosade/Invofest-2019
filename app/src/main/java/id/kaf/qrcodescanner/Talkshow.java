...
public class Talkshow extends AppCompatActivity implements View.OnClickListener {
    public static EditText kodeTiket;
    private Button btnSubmit, btnBack;

    private MyService service = ServiceGenerator.createService(MyService.class);
    private LinearLayout layoutTalkshow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Absensi Talkshow");
        ...
        layoutTalkshow = findViewById(R.id.layout_talkshow);
        ...
        switch (view.getId()){
            case R.id.kode_tiket:
                ...
                if(ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA)
                    ...
                    Intent intent = new Intent(Talkshow.this,
            ...
            case R.id.btn_submit:
                ...
                Call<String> call = service.talkshow(idTiket);
                call.enqueue(new Callback<String>() {
                    @Override
                    public void onResponse(Call<String> call, Response<String> response) {
                        pgBar.setVisibility(View.GONE);
                        kodeTiket.setText("");
                        Snackbar snackbar = Snackbar.make(layoutTalkshow,
