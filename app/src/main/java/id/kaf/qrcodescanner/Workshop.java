...
public class Workshop extends AppCompatActivity implements View.OnClickListener {
    ...
    private LinearLayout layoutWorkshop;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Absensi Workshop");
        ...
        layoutWorkshop = findViewById(R.id.layout_workshop);
        ...
        switch (view.getId()){
            case R.id.kode_tiket:
                ...
                if(ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA)
                    ...
                    Intent intent = new Intent(Workshop.this,
                            BarcodeScanner.class);
                    intent.putExtra("kategori", "workshop");
            ...
            case R.id.btn_submit:
                ...
                Call<String> call = service.workshop(idTiket);
                call.enqueue(new Callback<String>() {
                    @Override
                    public void onResponse(Call<String> call, Response<String> response) {
                        pgBar.setVisibility(View.GONE);
                        kodeTiket.setText("");
                        Snackbar snackbar = Snackbar.make(layoutWorkshop,
