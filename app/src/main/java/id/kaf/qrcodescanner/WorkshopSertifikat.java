...
public class WorkshopSertifikat extends AppCompatActivity implements View.OnClickListener {
    public static EditText kodeTiket;
    private Button btnSubmit, btnBack;

    private MyService service = ServiceGenerator.createService(MyService.class);
    private LinearLayout layoutSertifikatWorkshop;
    private ProgressBar pgBar;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sertifikat_workshop);
        getSupportActionBar().setTitle("Sertifikat Workshop");
        ...
        layoutSertifikatWorkshop = findViewById(R.id.layout_sertifikat_workshop);
        ...
        switch (view.getId()){
            case R.id.kode_tiket:
                ...
                if(ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA)
                    ...
                    Intent intent = new Intent(WorkshopSertifikat.this,
            ...
            case R.id.btn_submit:
                ...
                Call<String> call = service.sertifikat_workshop(idTiket);
                call.enqueue(new Callback<String>() {
                    @Override
                    public void onResponse(Call<String> call, Response<String> response) {
                        pgBar.setVisibility(View.GONE);
                        kodeTiket.setText("");
                        Snackbar snackbar = Snackbar.make(layoutSertifikatWorkshop,
